...
@Tag("coordinates-map-field")
@HtmlImport("src/component/coordinates-map-field.html")
public class CoordinatesMapField extends AbstractField<CoordinatesMapField,MyCoordinates> {

    public CoordinatesMapField() {
        this(new MyCoordinates(0.0,0.0));
    }

    public CoordinatesMapField(MyCoordinates defaultValue) {
        super(defaultValue);
